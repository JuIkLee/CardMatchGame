...
public class NextController implements Initializable {
	...
	@FXML ImageView next_card0, next_card1, next_card2 ,next_card3, next_card4, next_card5,
				   next_card6 ,next_card7 ,next_card8 ,next_card9, next_card10,
				   next_card11 ,next_card12, next_card13, next_card14, next_card15;
	...
	public int game_state = STATE_READY; 
	...
	public void OnMouseClickedRoot(MouseEvent event) {
		...
		if(game_state == STATE_READY) {
			 ...
			 * getClass().getResource("next_stage.fxml")); Parent root; root =
			 * loader.load(); Scene scene = new Scene(root);
			 * 
